...
Book My Package - A responsive tour and travel website built in Django and Python. 
...
1. Clone the repository: `git clone https://github.com/NithinKS10/BookMyPackage.git`
